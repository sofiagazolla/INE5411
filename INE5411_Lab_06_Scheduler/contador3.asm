...
.data
numeros3:  .byte 0x3F,0x06,0x5B,0x4F # 0, 1, 2, 3
.text

.globl prog3

prog3:
    	la   	$s7, numeros3       	# guarda o endereço base do array
    	li   	$s1, 0xFFFF0010     	# código do display direito (onde vai exibir)
...
loop3:
    	...
    	beq  $s2, 4, fim3		# verifica se já processou os 2 elementos (0, 1)
    	...
    	blt  	$s6, $s4, loop3      # espera até passar 1 segundo
    	...
    	j    	loop3			# repete o loop
    
fim3:
    	j 	inicializa3			# inicia a contagem novamente
