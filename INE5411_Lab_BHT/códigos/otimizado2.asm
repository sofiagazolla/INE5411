# Laboratório 05 - Exercício 1 -> 2º programa -> versão otimizada
.data
...
loop_busca:
	...
	#-------------- aqui foi feita a única alteração para a versão otimizada --------------
    	
    	seq 	$t5, $a1, $t4  		# se o número atual for igual ao que procuramos, found = 1
    	
    	or 	$a2, $a2, $t5			# garante que se em algum momento $a2 for 1, ele continue sendo 1
    	#--------------------------------------------------------------------------------------
